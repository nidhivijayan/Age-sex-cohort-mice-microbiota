...
In the above, F M03 is reference. sexM result suggests at M03, Male sig. higher than female at M03 (by 0.1515). Females at M23 not significantly different between females at M03 (p=0.43). The sex difference in month 23 is significantly different from the sex difference in M03 (p=0.0122),
